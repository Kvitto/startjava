...
public class GenerateUniqueArray {
    ...
    /*
     * Для последовальностей меньше 3 элементов невозможно сгенерировать уникальный массив если она пересикае 0.
     ...
     * Для этого в строке 24 производится декремент кол-ва циклов заполнения массива, чтобы оставить 0 в крайней ячейке.
